    ...
    return (
        <header>
            <nav className="navbar navbar-light bg-dark">
                <span className="navbar-brand  " style={{ color: 'white' }}>Todo list</span>
                <div style={{ flexDirection: "inherit", display: "flex", alignItems: "center", color: 'white' }}>
                    {!adding && (
                        <button type="button" className="btn btn-link btn-light " onClick={() => setAdding(true)}>
                            Add new item
                        </button>
                    )}
                    <Checkbox
